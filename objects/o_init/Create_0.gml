...
// changing room
if load_plot_state() = "started" or load_plot_state() = "found_key_in_ethan_bedroom" room_goto(r_ethan_bedroom)
else if load_plot_state() = "opened_door_in_ethan_bedroom" room_goto(r_livingroom)